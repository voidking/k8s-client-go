...
import (
	...
	nginxcontrollerv1 "k8s-client-go/k8scrdctrl/pkg/apis/nginx_controller/v1"
	versioned "k8s-client-go/k8scrdctrl/pkg/client/clientset/versioned"
	internalinterfaces "k8s-client-go/k8scrdctrl/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-client-go/k8scrdctrl/pkg/client/listers/nginx_controller/v1"
