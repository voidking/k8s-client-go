...
import (
	...
	nginxcontrollerv1 "k8s-client-go/demo9/pkg/apis/nginx_controller/v1"
	versioned "k8s-client-go/demo9/pkg/client/clientset/versioned"
	internalinterfaces "k8s-client-go/demo9/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-client-go/demo9/pkg/client/listers/nginx_controller/v1"
